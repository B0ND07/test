...
exports.register = async (req, res, next) => {
  try {
    ...
    res.cookie('accessToken', accessToken, {maxAge: 900000, httpOnly: false, secure: true, sameSite: 'None'}) //15m
...
exports.login = async (req, res, next) => {
  try {
    ...
    const { password, isAdmin, ...otherDetails } = user._doc;
    res.cookie('accessToken', accessToken, {maxAge: 60000, httpOnly: false, secure: true, sameSite: 'None'})
    res.cookie('refreshToken', refreshToken, 
